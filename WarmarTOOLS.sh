#!/bin/bash
#  
#       AutoTOOLInstaller v1.0 
#  
#             GitTool Create By : Wamar TOOLS
#             Youtube Channel : Comming Soon
#             GitHub : https://github.com/WarmarTools
...
echo "╚███╔███╔╝██║  ██║██║  ██║██║ ╚═╝ ██║██║  ██║██║  ██║   ██║   ╚██████╔╝╚██████╔╝███████╗███████║       ";
echo " ╚══╝╚══╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝   ╚═╝    ╚═════╝  ╚═════╝ ╚══════╝╚══════╝       ";
echo " Automatic recommend Tools instalation By WarmarTools                                                  ";

echo ""
echo -e $cyan"    Create by           $white":" $red WarmarTOOLS  "
echo -e $cyan"    Youtube Channel     $white":" $red Comming Soon"
echo -e $cyan"    Github              $white":" $red https://github.com/WarmarTools"
echo -e $cyan"    website             $white":" $red Comming Soon"
echo -e $cyan ""
echo -e $okegreen"====================== WarmarTOO's List =======================    ";
        echo
